...
def args_parser():
    ...
    parser.add_argument("--fl_algorithm", type=str, default= "FedDR", choices=["FedFW","FedAvg","FedDR", "FedProx"])
    parser.add_argument("--optimizer", type=str, default="PerturbedSGD", choices=["FW","GD", "SGD", "PGD", "PSGD", "PerturbedSGD"])
    ...
    parser.add_argument("--eta_0", type=float, default=1.0, help="step size")
